...
@Component({
  selector: 'app-media-coverage-detail',
  templateUrl: './media-coverage-detail.component.html',
  styleUrls: ['./media-coverage-detail.component.scss']
})
export class MediaCoverageDetailComponent implements OnInit, AfterViewInit {
